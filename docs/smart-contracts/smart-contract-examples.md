...
Secure multiparty computation [(MPC)](../pbc-fundamentals/partisia-blockchain-dictionary.md#mpc) extent the scope blockchain technology to encompass areas that before required some kind of independent third party to handle sensitive data like a trustee.
