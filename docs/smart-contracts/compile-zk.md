...
contract can be found in the example contracts archive at: `contracts/example-zk-second-price-auction`. You can download [our example zip archive here](../smart-contracts/combi-innovation.md) and read what a second-price auction is on that page as well.
