...
To deploy a smart contract you need an [account](../pbc-fundamentals/create-an-account.md) with [gas](../pbc-fundamentals/byoc-and-gas.md) to cover transaction costs.
...
Alternatively you can deploy for free test ETH [gas](../pbc-fundamentals/byoc-and-gas.md) on the [testnet](https://testnet.partisiablockchain.com/).
