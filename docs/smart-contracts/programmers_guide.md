...
Contracts' state and actions must be declared in an [Contract ABI file](../smart-contracts/abiv.md#abi-binary-format);
...
- ReadWriteState: Serialization for [State serialization format](../smart-contracts/abiv.md#state-binary-format).
- ReadWriteRPC: Serialization for [RPC argument serialization format](../smart-contracts/abiv.md#rpc-binary-format).
- CreateTypeSpec: Serialization for [ABI serialization format](../smart-contracts/abiv.md#abi-binary-format).
