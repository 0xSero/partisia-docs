# Introduction to the Partisia Blockchain Ecosystem

Below is a small introduction to the some of the core concepts of blockchains and an explanation of what makes Partisia Blockchain(PBC) different from other blockchains. 

### What is a blockchain

Blockchains are a means to make an immutable record of [transactions](transactions.md) on a decentralized database. This makes blockchains a useful place to record important information e.g. of a financial, medical or legal nature.  
