...
6. [Create a PBC Account](accounts.md)    
7. [Get MPC tokens](mpc-tokens.md)   
8. [Complete the Synaps KYB](synaps.md)   
9. [Create keys for config and registration](operator-6-keys.md)   
10. [Upgrade config to a block producing node on the VPS](operator-7-bp.md)   
11. [Register your node](operator-8-registration.md)   
12. [Node health and maintenance](operator-9-node-health.md)   