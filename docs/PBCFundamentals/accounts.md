...
A Partisia Blockchain account holds the information necessary to enabling the user to perform transactions. This information includes:
 ...
 - An account [nonce (number used only once)](dictionary.md#nonce), which is incremented when transactions are signed.
...
### Relevant pages
[Bring Your Own Coin (BYOC), Gas and generel pricing](byoc.md)