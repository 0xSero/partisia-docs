...
!!! Eaxmple "Calculation example"
    ...
    **Variables:**
    ...
    - **r(d)** is your delegated rewardable tokens. You delegate all your 20,000 MPC tokens to a node operator, half of your tokens are released, meaning 10,000 MPC tokens of the delegation is rewardable: $Delegated_{rewardable} = \frac{Released_{MPC}}{Total_{MPC}} Delegated = \frac{10,000}{20,000} 20,000 = 10,000$   
