...
2. You need to be able to cover gas costs of transaction, click [here](../pbc-fundamentals/byoc-and-gas-for-the-mainnet-and-testnet.md) for help to get gas in your account.
