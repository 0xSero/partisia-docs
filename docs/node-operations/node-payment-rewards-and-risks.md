...
- Tokens must be retrieved to your account balance to become fully [unstaked](https://browser.partisiablockchain.com/node-operation), meaning change state back from staked to unstaked. Unstaking causes a 7-day pending state for the tokens. Afterwards you invoke [Check pending unstakes](https://browser.partisiablockchain.com/account)
