...
| [stakedToContract](../pbc-fundamentals/mpc-token-model-and-account-elements.md#allocatedtojobs) ([Block Producer Orchestration ](https://browser.partisiablockchain.com/contracts/04203b77743ad0ca831df9430a6be515195733ad91))  | 28                  | The block producer orchestration contract holds the stake and registration of [baker nodes](../pbc-fundamentals/dictionary.md#baker-node) If you are in the committee when you invoke [Remove bp](https://browser.partisiablockchain.com/contracts/04203b77743ad0ca831df9430a6be515195733ad91/removeBp), the node will serve in committee until rotation. You can manually trigger a committee change when the committee is at least 28 days old. If your node is not in the current committee, the tokens will be disassociated from the contract immediately when invoking _Remove bp_.              | [Remove bp](https://browser.partisiablockchain.com/contracts/04203b77743ad0ca831df9430a6be515195733ad91/removeBp) the command removes you as a baker node and disassociates tokens from the contract                                                                                                            |
