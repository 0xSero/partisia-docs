...
- When tokens are retrieved from delegation by the owner they will not be [transferable](../pbc-fundamentals/mpc-token-model-and-account-elements.md#transferable) even if passed [vesting schedule](../pbc-fundamentals/mpc-token-model-and-account-elements.md#delegatedtoothers) until unstaked by the token owner
