...
Contracts' state and actions must be declared in an [Contract ABI file](abiv1.md#ABI Binary Format);
...
- ReadWriteState: Serialization for [State serialization format](abiv1.md#State Binary Format).
- ReadWriteRPC: Serialization for [RPC argument serialization format](abiv1.md#RPC Binary Format).
- CreateTypeSpec: Serialization for [ABI serialization format](abiv1.md#ABI Binary Format).
