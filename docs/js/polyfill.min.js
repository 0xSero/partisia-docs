...
(function (self, undefined) {
    ...
    !(function () {
      ...
      (function () {
        ...
        function P(t, e, r) {
          ...
          "__proto__" in n ? (n.__proto__ = h) : ((n.from = h.from), (n.of = h.of)),
        ...
        (h.prototype = T),
          ...
          Object.defineProperty(h.prototype, "copyWithin", {
            value: function (t, e) {
              ...
              var b,
                g = Y(c - s, a - h);
              for (
                s < h && h < s + g ? ((b = -1), (s = s + g - 1), (h = h + g - 1)) : (b = 1);
                g > 0;
          ...
          Object.defineProperty(h.prototype, "reverse", {
            value: function () {
              if (this === B || null === this) throw TypeError();
              for (
                var t = Object(this), e = f(t.length), r = m(e / 2), n = 0, o = e - 1;
                n < r;
                ++n, --o
              ) {
                var i = t._getter(n);
          ...
          Object.defineProperty(h.prototype, "set", {
            value: function (t, e) {
              ...
              if (
                ...
                if (
                  ((n = arguments[0]), (i = f(n.length)), (o = f(arguments[1])) + i > this.length)
                )
                  throw RangeError("Offset plus length of array is out of range");
  ...
  if (
    ...
    !(function (e) {
      ...
      Object.defineProperty = function n(o, i, f) {
        if (
          e &&
          (o === window || o === document || o === Element.prototype || o instanceof Element)
        )
          return e(o, i, f);
  ...
  if (!("bind" in Function.prototype)) {
    CreateMethodProperty(Function.prototype, "bind", function t(n) {
      ...
      return (
        ...
        u.prototype && ((l.prototype = u.prototype), (y.prototype = new l()), (l.prototype = null)),
        y
      );
    });
  }
  ...
  if (!("fround" in Math)) {
    CreateMethodProperty(Math, "fround", function (n) {
      return isNaN(n)
        ? NaN
        : 1 / n == +Infinity || 1 / n == -Infinity || n === +Infinity || n === -Infinity
          ? n
  ...
  if (!("isInteger" in Number)) {
    CreateMethodProperty(Number, "isInteger", function e(n) {
      return (
        "number" === Type(n) && !isNaN(n) && n !== Infinity && n !== -Infinity && ToInteger(n) === n
      );
    });
  }
  if (!("isNaN" in Number)) {
    ...
    CreateMethodProperty(
      ...
      (function () {
        ...
        return function s(o) {
          ...
          if (a && o.length > 0) for (var g = 0; g < o.length; ++g) s.push(String(g));
          else
            for (var w in o)
              (t() && "__proto__" === w) ||
                (y && "prototype" === w) ||
    ...
    CreateMethodProperty(String, "fromCodePoint", function r(o) {
      for (var t = [], e = arguments, n = arguments.length, a = [], i = 0; i < n; ) {
        ...
        if (!1 === SameValue(p, ToInteger(p)))
          throw new RangeError("Invalid code point " + Object.prototype.toString.call(p));
        if (p < 0 || p > 1114111)
          throw new RangeError("Invalid code point " + Object.prototype.toString.call(p));
    ...
    !(function (e) {
      ...
      Object.defineProperty(u, "isMapIterator", {
        ...
        CreateMethodProperty(u, "next", function _() {
          ...
          if (!t._es6Map)
            throw new Error(
              Object.prototype.toString.call(t) + " has a [[MapData]] internal slot."
            );
        ...
        _resolve: {
          value: function (t) {
            ...
            return this.__nextIndex__ === this.__length__
              ? r
              : ((e = r.charCodeAt(0)),
                e >= 55296 && e <= 56319 ? r + this.__list__[this.__nextIndex__++] : r);
          },
          configurable: !0,
          enumerable: !1,
          writable: !0,
  ...
  if (
    !("Symbol" in self && "iterator" in self.Symbol && !!String.prototype[self.Symbol.iterator])
  ) {
  ...
  if (!("Promise" in self)) {
    !(function () {
      ...
      function y(n, t, e) {
        ...
        if (n._s === $)
          for (
            n._s = t, n._v = e, t === O && (I && o(e) && (e.longStack = w(e, n)), on(n));
            r < i;
